...
public class BilinkedList280<I> extends LinkedList280<I> implements BilinearIterator280<I>
{
	...
	protected BilinkedNode280<I> createNewNode(I item)
	{
		...
		// NOTE: Remove the next line before you write this method.  It is only here to prevent a compiler error
		return null;
	}
	...
	{
		// TODO 
		// Hint: if you delete the item at which the cursor is positioned, where do you then position the cursor?
	}
